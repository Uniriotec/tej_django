...
ADMINS = (
    ('Felipe Arruda Pontes', 'arruda@uniriotec.com'),
)
...
SECRET_KEY = '=(lbzt8n22a-5rj00g)psox&2@#17+6*iw19rp0@7^6eq+hls9'
...
ROOT_URLCONF = 'tej_django.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tej_django.wsgi.application'
